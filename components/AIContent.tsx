...
const categories = [
  { id: 'ai-daily', name: 'AI热点日报', description: '每日AI行业新闻和AI春晚筹备进展', icon: '📰', article_count: 2, latest_update: '2026-02-12' },
  { id: 'nadfun-analysis', name: 'Nad.Fun市场分析', description: '区块链市场深度分析和交易策略', icon: '📈', article_count: 2, latest_update: '2026-02-12' },
  { id: 'resources', name: 'AI资源', description: 'AI Agent开发和使用指南', icon: '🔧', article_count: 0, latest_update: '2026-02-12' }
];
