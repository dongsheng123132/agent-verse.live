...
export const EventsPage: React.FC = () => {
  const [currentSection, setCurrentSection] = React.useState(NavSection.EVENTS);
...
const Footer: React.FC = () => (
  <footer className="border-t border-gray-800 bg-black/90 py-8 text-center text-gray-400">
    <div className="max-w-4xl mx-auto px-4">
      <p className="text-sm text-gray-600">AgentVerse Events - Powered by OPENCLAW ENGINE</p>
    </div>
  </footer>
);
